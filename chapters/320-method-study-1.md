...
The setting for this contribution to this research is a [or two, or + engineering] Masters&#39; level Learning Sciences unit at the University of Sydney, in which learners collaborate on system model design over the course of the semester as an ordinary part of the learning outcomes.
...
_Table 1: Study 1 Student activities over the teaching session._
...
_Table 2: Designed environment features in detail._
...
However, due to a university restructure, the IT infrastructure for these surveys was delayed by four months, meaning data collection did not proceed at planned, and it was necessary to reformulate the study.

_Table 3: Data collection timeline in Study 1._
...
##### I am leaving this as I&#39;ve spent two days on Factor Analysis and still don&#39;t think I understand how to do it. I know that the random /known
...
_Table 5: Breakdown of constructs by team and originality/uniqueness._
...
### Analysis – Data Collection 1 – comparing teams
...
_Table 6: Similarity in construct and element rating from highest to lowest._
...
_Table 7: Table of all contributions and theme chunking with track of who provided which construct._
...
| Chat oriented — collaborative environment | dyaramak | A | Collaboration versus chat/communication |
 |
 |
| Social media — collaborative environment | dyaramak | A | Collaboration versus versus social |
 |
 |
...
\&lt;consider Plenary recordings as well? \&gt;
...
### Data Collection 2 – analysis

[Read through of Team meeting transcripts]

Full analysis of this data has not been completed. Design decisions from this study informed the collaboration environment design of Study 2. A summary of in-session emergent challenges is below at Table [T]. These were all mitigated in real time as described.
